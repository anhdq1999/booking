  ...
  return (
    <div>
      ...
      <div className="content-block" id="page_content">
        ...
        <div className="section-full content-inner bg-img-fix overlay-black-middle"
             style={{ backgroundImage: "url(" + bg1 + ")" }}>
          <div className="container">
            <div className="video-banner-box">
              <div>
                <Link to={"https://www.youtube.com/watch?v=Dj6CKxQue7U"} className="popup-youtube video play-btn"><i
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="dlab-box packages-bx">
                  <div className="dlab-media">
                    <Link to={"listing-details-1"}><img src={require("./../../images/gallery/img5.jpg")}
                                                        alt="" /></Link>
              ...
              <div className="col-lg-6">
                <div className="dlab-box packages-bx">
                  <div className="dlab-media">
                    <Link to={"listing-details-1"}><img src={require("./../../images/gallery/img2.jpg")}
                                                        alt="" /></Link>
                    <span className="tag yellow">Best Seller</span>
                  </div>
                  <div className="dlab-info">
              ...
              <div className="col-lg-6">
                <div className="dlab-box packages-bx">
                  <div className="dlab-media">
                    <Link to={"listing-details-1"}><img src={require("./../../images/gallery/img3.jpg")}
                                                        alt="" /></Link>
                    <span className="tag yellow">Best Seller</span>
                  </div>
                  <div className="dlab-info">
              ...
              <div className="col-lg-6">
                <div className="dlab-box packages-bx">
                  <div className="dlab-media">
                    <Link to={"listing-details-1"}><img src={require("./../../images/gallery/img4.jpg")}
                                                        alt="" /></Link>
                    <span className="tag yellow">Best Seller</span>
                  </div>
                  <div className="dlab-info">
