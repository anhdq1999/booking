...
import RoomsManager from "../admin/room-manager/RoomsManager";
      ...
      <div className="dlab-bnr-inr overlay-black-middle"
        ...
        <div className="container">
          <div className="dlab-bnr-inr-entry">
            <h1 className="text-white">Host manager</h1>
                ...
                <div className="col-xl-8 col-lg-7 col-md-12">
                  <div className="content-box">
                    ...
                    <div className="content-footer content-btn">
                      <Link data-toggle="modal" data-target="#favorite" to={""} className="site-button"><i
                        className="la la-star-o m-r5"></i> ADD A REVIEW</Link>
                    </div>
                  </div>
                  <div className="content-box">
                    <div className="content-header">
                  ...
                  <div className="content-box">
                    <div className="content-header">
                      <h3 className="title"><i className="la la-file-image-o"></i> ROOMS</h3>
                    </div>
                    <div className="content-body">
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-6">
                          <div className="listing-bx event-listing m-b10">
                            ...
                            <div className="event-bottom">
                              <ul>
                                <li className="event-hosted"><span>Hosted By </span> <Link to={""}>John Smith</Link>
                                </li>
                  ...
                  <div className="comments-review-area">
                    <div className="comments-review-box">
                      <div className="review-header">
                        ...
                        <div className="clearfix d-flex">
                          ...
                          <div className="dropdown dropdown-btn dropdown-btn-sm">
                            <button className="site-button-link button-xl dropdown-toggle" type="button"
                                    id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                              <i className="fa fa-ellipsis-v"></i>
                            </button>
                            <div className="dropdown-menu  dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                              <Link className="dropdown-item" data-toggle="modal" data-target="#report-reviews" to={""}><i
                      ...
                      <div className="review-body">
                        ...
                        <p className="review-content">There are many variations of passages of Lorem Ipsum available,
                          ...
                          <ul>
                            ...
                            <li>
                              <div className="dropdown dropdown-btn">
                                <button className="site-button-link dropdown-toggle" type="button"
                                        id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                            ...
                            <li>
                              <div className="review-comment-author">
                                ...
                                <div className="comment-info">
                                  ...
                                  <p className="comment-text">There are many variations of passages of Lorem Ipsum
                    ...
                    <div className="comments-review-box">
                      ...
                      <div className="review-body">
                        <h3 className="review-title"><Link to={""}>Food & Drink</Link></h3>
                        <p className="review-content">Lorem Ipsum is simply dummy text of the printing and typesetting
                          industry</p>
                      </div>
                      <div className="review-footer">
                        <div className="review-btn">
                      ...
                      <div className="content-body">
                        <div className="widget recent-posts-entry posts-style1 posts-column-2">
                          <div className="widget-post-bx">
                            <div className="widget-post clearfix">
                              <div className="dlab-post-media">
                                <img src={require("../../../images/blog/recent-blog/pic1.jpg")} width="200" height="143"
                                     alt="" />
                                <span className="abb-bx">Add</span>
                              </div>
                              <div className="dlab-post-info">
                                <div className="dlab-post-header">
                                  <h6 className="post-title"><Link to={""}>Moments To Remember From Directory</Link>
                                  </h6>
                          ...
                          <div className="widget-post-bx">
                            <div className="widget-post clearfix">
                              <div className="dlab-post-media">
                                <img src={require("../../../images/blog/recent-blog/pic2.jpg")} width="200" height="143"
                                     alt="" />
                                <span className="abb-bx">Add</span>
                              </div>
                              <div className="dlab-post-info">
                          ...
                          <div className="widget-post-bx">
                            <div className="widget-post clearfix">
                              <div className="dlab-post-media">
                                <img src={require("../../../images/blog/recent-blog/pic3.jpg")} width="200" height="143"
                                     alt="" />
                                <span className="abb-bx">Add</span>
                              </div>
                              <div className="dlab-post-info">
                    ...
                    <div className="content-box">
                      ...
                      <div className="content-body">
                        ...
                        <ul className="list-inline m-tb20">
                          ...
                          <li><Link to={""} className="site-button sharp"><i className="fa fa-google-plus"></i></Link>
                          </li>
                          <li><Link to={""} className="site-button sharp"><i className="fa fa-linkedin"></i></Link></li>
                          <li><Link to={""} className="site-button sharp"><i className="fa fa-instagram"></i></Link>
                          </li>
                        ...
                        <div className="col-lg-4">
                          <div className="listing-bx event-listing m-b30">
                            ...
                            <div className="listing-info">
                              <h3 className="title"><Link to={""}>Moments To Remember From Directory</Link></h3>
                              <ul className="event-meta">
                                <li className="event-date"><span className="text-primary">SEP</span> <strong>04</strong>
                                </li>
                                <li>Tuesday 08:00</li>
                                <li>Sydney NSW, Australia</li>
                                <li>44 people interested</li>
