...
import AdminHome from "./markup/Pages/admin/AdminHome";
import HostListingDetails from "./markup/Pages/host/HostListingDetails";
      ...
      <Router history={history} basename="/">
        <div className="page-wraper">
          <Switch>
            ...
            <Route path={["/admin", "/admin/home"]} exact component={AdminHome} />
            <Route path={["/host", "/host/manager"]} exact component={HostListingDetails} />
            ...
            <Route path="/rooms" exact component={RoomsManager} />
