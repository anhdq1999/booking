...
const GET_ROOM_BY_HOST_ID = {
  SUCCESS: (data) => {
    return {
      success: true,
      action: constants.room.GET_ROOM_BY_HOST_ID_CONSTANTS.action,
      message: constants.room.GET_ROOM_BY_HOST_ID_CONSTANTS.message.success,
      data: data
    };
  },
  FAILURE: () => {
